...
inline std::string to_yaml(const TurnOff_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const pi_hub_srvs::srv::TurnOff_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const pi_hub_srvs::srv::TurnOff_Request & msg)
{
...
inline std::string to_yaml(const TurnOff_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use pi_hub_srvs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const pi_hub_srvs::srv::TurnOff_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  pi_hub_srvs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use pi_hub_srvs::srv::to_yaml() instead")]]
inline std::string to_yaml(const pi_hub_srvs::srv::TurnOff_Response & msg)
{
  return pi_hub_srvs::srv::to_yaml(msg);
}
