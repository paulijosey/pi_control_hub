...
#ifndef PI_HUB_SRVS__SRV__DETAIL__TURN_ON__FUNCTIONS_H_
#define PI_HUB_SRVS__SRV__DETAIL__TURN_ON__FUNCTIONS_H_
...
/// Create srv/TurnOn message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pi_hub_srvs__srv__TurnOn_Request__init().
...
/// Destroy srv/TurnOn message.
/**
 * It calls
 * pi_hub_srvs__srv__TurnOn_Request__fini()
...
/// Check for srv/TurnOn message equality.
/**
...
/// Initialize array of srv/TurnOn messages.
/**
...
/// Finalize array of srv/TurnOn messages.
/**
 * It calls
 * pi_hub_srvs__srv__TurnOn_Request__fini()
...
/// Create array of srv/TurnOn messages.
/**
 * It allocates the memory for the array and calls
 * pi_hub_srvs__srv__TurnOn_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TurnOn messages.
/**
 * It calls
 * pi_hub_srvs__srv__TurnOn_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/TurnOn message array equality.
/**
...
/// Copy an array of srv/TurnOn messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pi_hub_srvs__srv__TurnOn_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pi_hub_srvs
...
/**
 * It calls
 * pi_hub_srvs__srv__TurnOn_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_pi_hub_srvs
...
/**
 * It allocates the memory for the array and calls
 * pi_hub_srvs__srv__TurnOn_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pi_hub_srvs
...
/**
 * It calls
 * pi_hub_srvs__srv__TurnOn_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PI_HUB_SRVS__SRV__DETAIL__TURN_ON__FUNCTIONS_H_
