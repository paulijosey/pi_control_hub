...
class Metaclass_Control(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from pi_hub_srvs.srv import _control
...
class Control(metaclass=Metaclass_Control):
    from pi_hub_srvs.srv._control import Control_Request as Request
    from pi_hub_srvs.srv._control import Control_Response as Response
